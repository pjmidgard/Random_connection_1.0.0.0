                                        ...
                                        while Times!=76:
                                            ...
                                            while Times2!=76:
                                                ...
                                                if Times>=0 and Times2>=0 and Calculus[Times:Times+3]!=Calculus[Times2:Times2+3] and Times2!=Times:
                                                    ...
                                                    if opssite_equal==1 and Calculus[Times:Times+3]=="000" and Calculus[Times+4:Times+5]==Equal_Not_compress[3:4] and Calculus[Times2:Times2+3]=="000" and Calculus[Times2+4:Times2+5]==Equal_Not_compress[3:4] and Number_Times>-1 and Number_Times<16 and Times3//4>1 and Times3//4<16:
                                            ...
                                            while Times3!=156:
                                                ...
                                                while Times4!=156:
                                                    ...
                                                    if Times3>=80 and Times4>=80 and Calculus[Times3:Times3+3]!=Calculus[Times4:Times4+3] and Times4!=Times3:
                                                        ...
                                                        if opssite_equal==1 and Calculus[Times3:Times3+3]=="000" and Calculus[Times3+4:Times3+5]==Equal_Not_compress[3:4] and Calculus[Times4:Times4+3]=="111" and Calculus[Times4+4:Times4+5]==Equal_Not_compress[3:4] and Number_Times>-1 and Number_Times<16 and Times//4>1 and Times//4<16:
