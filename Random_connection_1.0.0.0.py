                            ...
                            with open(nameas, "ab") as f2:
                                ...
                                while cout_compress!=255:
	                                ...
	                                while block<long:
	                                                ...
	                                                while Times!=76:
	                                                           ...
	                                                           while Times2!=76:
	                                                                       ...
	                                                                       if Times>=0 and Times2>=0 and Calculus[Times:Times+4]!=Calculus[Times2:Times2+4] and Times2!=Times:
	                                                                       	...
	                                                                       	Number_Times2=-((Times2//4)-(Times//4))-1
	                                                                       	Change=Calculus[Times:Times+4]
	                                                                       	Change2=Calculus[Times2:Times2+4]
	                                                                       	...
	                                                                       	if Calculus[Times:Times+4]==Equal_Not_compress2 and Calculus[Times+4:Times+5]!=Equal_Not_compress2[3:4]:
	                                                                       		Calculus=Calculus[:Times]+Change2+Calculus[Times+4:]
	                                                                        ...
	                                                                        if Times>=0 and Times2>=0 and Calculus[Times:Times+4]!=Calculus[Times2:Times2+4] and Times2!=Times:
	                                                                                       ...
	                                                                                       if Number_Times>0 and Number_Times<=7 and compress_start==0:
	                                                                                       	...
	                                                                                       	save_06=Calculus2[:Times+3]+Calculus2[Times+4:80]	   
	                                                                                      
                                                                                    	
	                                                                                       	if len(save_05)==79 or len(save_06)==79:
	                                                                                       		compress2=1
	                                                                                       		compress_start=1
	                                                ...
	                                                while Times3!=156:
	                                                      ...
	                                                      while Times4!=156:
	                                                            ...
	                                                            if Times3>=80 and Times4>=80 and Calculus[Times3:Times3+4]!=Calculus[Times4:Times4+4] and Times4!=Times3:
	                                                                       	...
	                                                                       	Number_Times2=-(Times4//4)-(Times4//4)-1
	                                                                       	Change=Calculus[Times3:Times3+4]
	                                                                       	Change2=Calculus[Times4:Times4+4]
	                                                                       	Equal_Not_compress=format(Number_Times,'04b')
	                                                                       	Equal_Not_compress2=format(Number_Times2,'04b')
	                                                                       	...
	                                                                       	if Calculus[Times3:Times3+4]==Equal_Not_compress and Calculus[Times3+4:Times3+5]!=Equal_Not_compress[3:4]:
	                                                                       		Calculus=Calculus[:Times3]+Change2+Calculus[Times3+4:]
	                                                                       	
	                                                                       		compress5=1
	                                                                       		compress7=1	                                                                       		
	                                                            if Times3>=80 and Times4>=80 and Calculus[Times3:Times3+4]!=Calculus[Times4:Times4+4] and Times4!=Times3:
	                                                               Number_Times2=((Times3//4)-(Times4//4))-1
	                                                               Number_Times2=-((Times4//4)-(Times3//4))-1
	                                                               ...
	                                                               if Number_Times2>0 and Number_Times2<=7 and compress_start2==0 and compress2==1:
	                                                                      ...
	                                                                      save_07=save_06+Calculus2[80:Times3+3]+Calculus2[Times3+4:]
	                                                                      
	                                                                      if len(save_03)==158 or len(save_07)==158: 
	                                                                      	compress=1
	                                                                      	compress3=1
	                                                                      	compress_start2=1
	                                                ...
	                                                if compress3==1 and compress6==0 and compress7==0:
	                                                    save_04="0"+save_07
	                                                    print(len(save_04))
	                                                    

	                                                elif compress3==1 and compress6==1 and compress7==1:
	                                                    save_04="0"+save_03
	                                                    #print(len(save_04))
